...
import CCTV_module_0502 as k
setting = k.setroading()
#모둘 불러오기
from CCTV_module_0502 import securityshot, securityrec
    ...
    while True:
        ...
        if (stop and start):
            ...
            if 10 < distance <= 30:
                ...
                print('road set:'+setting)
                time.sleep(0.001)
                #스냅샷기능
                securityshot(setting)
                print('inputted set:'+setting)
                print('shot')
            elif distance <= 10:
                #10거리 진입시 발생하는 이벤트
                print('road set:'+setting)                
